...
Core algorithm is paper-faithful: Stage I anchors attempt 1 to the reference policy via KL, Stage II adds the reward-shaping bonus `α · (r(y2) − r(y1))`. Practical deviations:
