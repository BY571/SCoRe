...
We use the `<think>...</think><answer>...</answer>` reasoning-tag format introduced by [DeepSeek-R1](https://arxiv.org/abs/2501.12948) (the GRPO paper) — model reasons inside `<think>`, gives the final answer inside `<answer>`.
